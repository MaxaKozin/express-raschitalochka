...
export default function RegistrationMobile({ name, email, password, isValidEmail, isEqualPassword, onChangeNameHandler, onChangeEmailHandler, onChangePasswordHandler, onBlurEmailHandler, onChangeConfrimPassHandler, checkStrenthPassHandler, onSubmitHandler, isBtnNotDisable }) {

...
export default function RegistrationDesktop({ name, email, password, isValidEmail, isEqualPassword, onChangeNameHandler, onChangeEmailHandler, onChangePasswordHandler, onBlurEmailHandler, onChangeConfrimPassHandler, checkStrenthPassHandler, onSubmitHandler, isBtnNotDisable }) {

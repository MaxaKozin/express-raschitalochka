...
export default function LoginDesktop({ email, password, isValidEmail, onChangeEmailHandler, onChangePasswordHandler, onBlurEmailHandler, onSubmitHandler, isBtnNotDisabled }) {
  return (
